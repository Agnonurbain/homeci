...
exports.aggregateDailyStats = void 0;
/**
...
exports.aggregateDailyStats = (0, scheduler_1.onSchedule)({
    ...
    firebase_admin_1.logger.info(`[Daily Stats] Agrégation pour ${dateStr}...`);
    ...
    firebase_admin_1.logger.info(`[Daily Stats] ${dateStr} — users: ${stats.new_users}, propriétés: ${stats.new_properties}, visites: ${stats.new_visits}, certifications: ${stats.new_certifications}, signalements: ${stats.new_reports}`);
});

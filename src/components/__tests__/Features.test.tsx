...
describe('Features', () => {
  ...
  it('affiche le titre NOS ENGAGEMENTS', () => {
    render(<Features />);
  ...
  it('affiche les descriptions des fonctionnalités', () => {
    ...
    expect(screen.getByText(/Zéro arnaque/)).toBeInTheDocument();
    expect(screen.getByText(/Abidjan à San Pedro/)).toBeInTheDocument();
  });
});

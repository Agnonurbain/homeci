    ...
    <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Type, description et prix du bien</p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          ...
          <select name="property_type" value={formData.property_type} onChange={onChange} className={inputCls} style={S.input}>
        ...
        <div>
          ...
          <select name="transaction_type" value={formData.transaction_type} onChange={onChange} className={inputCls} style={S.input}>
      ...
      <div>
        ...
        <input type="text" name="title" value={formData.title} onChange={onChange} className={inputCls} style={S.input} placeholder="Ex: Belle villa avec piscine à Cocody" />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          ...
          <input type="number" name="price" value={formData.price} onChange={onChange} className={inputCls} style={S.input} min="0" placeholder="0" />
        </div>
        <div>
          <label className="block mb-1.5" style={S.label}>Disponible à partir du</label>
          <input type="date" name="available_from" value={formData.available_from} onChange={onChange} className={inputCls} style={S.input} />
        </div>
      </div>
    </div>
  );

...
export type AdminTab = 'overview' | 'users' | 'properties' | 'verification' | 'notaires' | 'reports' | 'surveys' | 'visits' | 'user-search' | 'security' | 'admin-management' | 'cgv' | 'ads' | 'audit' | 'exports' | 'analytics';

// Re-export canonical compressImage from compressImage.ts
// to avoid having two implementations
export { compressImage, compressImages, COMPRESS_PRESETS } from './compressImage';
